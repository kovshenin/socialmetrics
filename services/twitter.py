...
def new():
	return OAuthApi(CONSUMER_KEY, CONSUMER_SECRET)

def restore(access_token, access_token_secret):
	return OAuthApi(CONSUMER_KEY, CONSUMER_SECRET, access_token, access_token_secret)
